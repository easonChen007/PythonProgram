    ...
    def run_event(self, product_name, addr):
        ...
        if addr:
            ...
            for e_product_color in element:
                ...
                v_product_color_name = e_product_color.get_attribute('data-attribute-value')
                ...
                for e_product_model in element_model:
                    v_product_model_name = e_product_model.get_attribute('data-attribute-value')
                    v_product_model_status = e_product_model.get_attribute('class')
                ...
                Notification.send_to_telegram(s_main_product_color+' 【'+s_sub_product_model +'】')
